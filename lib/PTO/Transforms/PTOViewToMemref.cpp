...
static bool hasMigratedTileNativeOp(func::FuncOp func) {
  ...
  auto result = func.walk([&](Operation *op) {
    if (isa<pto::TReshapeOp, pto::BitcastOp, pto::SetValidShapeOp,
            ...
            pto::TColExpandMinOp, pto::TExpandsOp, pto::TSetValOp,
            ...
            pto::TColMaxOp, pto::TColMinOp, pto::TColSumOp,
            pto::TCvtOp, pto::TGatherOp, pto::TGatherBOp, pto::TCIOp,
            ...
            pto::TFModOp, pto::TFModSOp, pto::TShlOp, pto::TShlSOp,
            pto::TShrOp, pto::TShrSOp, pto::TPartMaxOp,
            pto::TPartMinOp, pto::TColExpandAddOp, pto::TColExpandSubOp,
            pto::TColExpandDivOp, pto::TColExpandExpdifOp,
            pto::TRowExpandOp, pto::TRowExpandAddOp,
            pto::TRowExpandSubOp, pto::TRowExpandMulOp,
            pto::TRowExpandDivOp, pto::TRowExpandMaxOp,
            pto::TRowExpandMinOp, pto::TRowExpandExpdifOp,
            pto::TRowMaxOp, pto::TRowMinOp, pto::TRowSumOp,
            pto::TRowProdOp, pto::TColProdOp, pto::TColArgMaxOp,
            pto::TColArgMinOp, pto::TRowArgMaxOp, pto::TRowArgMinOp,
            pto::TPartArgMaxOp, pto::TPartArgMinOp, pto::TPowOp,
            pto::TPowSOp, pto::TRsqrtOp, pto::TPReluOp,
            pto::TRemOp, pto::TRemSOp, pto::TSelOp,
            pto::TSelSOp, pto::TXorOp, pto::TXorSOp,
            pto::TSort32Op, pto::TQuantMxOp, pto::TAxpyOp,
            pto::TDequantOp, pto::TFillPadExpandOp,
            pto::TGetScaleAddrOp, pto::TMovOp,
            pto::TStoreFPOp, pto::THistogramOp, pto::TRandomOp,
            pto::TScatterOp, pto::TTriOp, pto::TMatmulOp,
            ...
            pto::TPrefetchOp, pto::TPushOp, pto::TPopOp,
            pto::TFreeOp, pto::TSyncOp, pto::BuildAsyncSessionOp>(op)) {
      found = true;
      return WalkResult::interrupt();
    }
    return WalkResult::advance();
